...
const ProductCard = ({ product, buyNow }) => {
  ...
  useEffect(() => {
    ...
    // ✅ If selected variant was deleted
  ...
  useEffect(() => {
    if (product.lastAddedVariantId) {
      setSelectedVariantId(product.lastAddedVariantId);
    }
  }, [product.lastAddedVariantId]);
    ...
    dispatch(
      addToCart({
        ...
        selectedVariant: {
          ...
          product_image:
            selectedVariant.product_image || product.image1,
        },
      })
    );
  };
